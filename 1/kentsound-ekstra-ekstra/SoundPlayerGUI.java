    ...
    implements ListSelectionListener
{
    ...
    {
        String text = "Total tracks played: " + player.getNumberOfTracksPlayed() + "\n"
                      + "Total track time: " + player.getTotalPlayedTrackLength() + "\n"
                      + "Average track time: " + player.averageTrackLength();
       ...
       JPanel centerPane = new JPanel();
        {
            ...
            JLabel image = new JLabel(new ImageIcon("arbeidskrav-navn.jpg"));
        ...
        JPanel toolbar = new JPanel();
        {
            ...
            button.addActionListener(new ActionListener() {
                                   public void actionPerformed(ActionEvent e) { showStatistics(); }
                               });
            toolbar.add(button);
        }
